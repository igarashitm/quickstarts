...
public class OrderServiceBean implements OrderService {
    ...
    private AnotherInventoryService _inventory;
    ...
    public OrderAck submitOrder(Order order) {
        ...
        // Check the inventory
        try {
            HashMap<String,String> orderItem = _inventory.lookupItem(order.getItemId());
            // Check quantity on hand and generate the ack
            if (Integer.parseInt(orderItem.get("quantity")) >= order.getQuantity()) {
