...
public class JsonTransformationTest {
    ...
    @ServiceOperation("ProcessJsonOrderService.process")
    ...
    @Test
    public void testInvokeViaReference() throws Exception {
        String result = process
                .sendInOut(_testKit.readResourceString(ORDER_JSON))
                .getContent(String.class);
        Assert.assertEquals(_testKit.readResourceString(ORDER_ACK_JSON), result);
    }
}
